...
export default function Navbar() {
    ...
    const navLinks = (
        <>
            <Link
                href="/"
                className={`md:px-2 lg:px-3 py-2 font-medium flex items-center gap-2 ${
                    pathname === "/" ? "text-blue-600 font-semibold" : "text-gray-700 hover:text-gray-900"
                }`}
            ...
            <Link
                href="/browse-listing"
                className={`md:px-2 lg:px-3 py-2 font-medium flex items-center gap-2 ${
                    pathname === "/browse-listing" ? "text-blue-600 font-semibold" : "text-gray-700 hover:text-gray-900"
                }`}
                onClick={() => setMobileMenuOpen(false)}
            >
            ...
            <Link
                href="/reviews"
                className={`md:px-2 lg:px-3 py-2 font-medium flex items-center gap-2 ${
                    pathname === "/reviews" ? "text-blue-600 font-semibold" : "text-gray-700 hover:text-gray-900"
                }`}
                onClick={() => setMobileMenuOpen(false)}
            >
            ...
            <Link
                href="/about-us"
                className={`md:px-2 lg:px-3 py-2 font-medium flex items-center gap-2 ${
                    pathname === "/about-us" ? "text-blue-600 font-semibold" : "text-gray-700 hover:text-gray-900"
                }`}
                onClick={() => setMobileMenuOpen(false)}
            >
            ...
            <Link
                href="/contact"
                className={`md:px-2 lg:px-3 py-2 font-medium flex items-center gap-2 ${
                    pathname === "/contact" ? "text-blue-600 font-semibold" : "text-gray-700 hover:text-gray-900"
                }`}
                onClick={() => setMobileMenuOpen(false)}
            >
    ...
    return (
        <nav
            className={`fixed w-full top-0 z-50 bg-white border-b border-gray-200 transition-colors duration-300 ${
                scrolled ? "shadow-md" : ""
            }`}
        >
